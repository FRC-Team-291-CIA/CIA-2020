...
public class CIA_Dump {
    ...
    private String currentState = "State_Not_Set_Yet"; //Used for the smartdhaboard

    /*
    Below is a contructor that takes in the following:
    ...
    */
    ...
    //Below is used to set the solenoids into posistion
    ...
    public void setDumpState(dumpState wantedState){
        switch(wantedState){ //Checks to see which state is the wanted state
            ...
            case CLOSED: //Used if its wanted to be closed
                currentState = "CLOSED"; //Sets the data used in smartdashbaord
